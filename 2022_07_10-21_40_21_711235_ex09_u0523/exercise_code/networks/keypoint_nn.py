...
class KeypointModel(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.model = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=32, kernel_size=4, padding=2),
            nn.ELU(),
            nn.MaxPool2d(4),
            nn.Dropout(0.4),
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=4, padding=4),
            nn.ELU(),
            nn.MaxPool2d(4),
            nn.Dropout(0.4),
            nn.Flatten(),
    ...
    def configure_optimizers(self):
        optim = torch.optim.Adam(self.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08)
        return optim
